...
class blueMLAnalysis():
    ...
    def __init__(self, n_tweezers, model_path, r_atom=2.5, tweezer_positions=None, make_plots=True):
        """
    ...
    def train_model(self, data_path, green_model_path, blue_model_path=None, training_kwargs=DEFAULT):
        """
        ...
        crops = self.make_crops(nuvu_stack)
        labels = self.make_labels(pv_stack, green_model)
    ...
    def make_labels(self, pv_stack, green_model):
        ...
        pv_crops = self.make_crops(pv_stack)
    ...
    def make_crops(self, stack):
        ...
        """
        crops_3x3 = self.img_processor.crop_tweezers(stack, 3)
